...
void cli_switch_to_central(sl_cli_command_arg_t *arguments);
void cli_switch_to_peripheral(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_phy_scan_set = \
  SL_CLI_COMMAND(cli_throughput_central_phy_scan_set,
                 "Set PHY used for scanning",
                  "Scan PHY, 1:1M 4:Coded PHY, 5:1M and Coded" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd__switch_to_central = \
  SL_CLI_COMMAND(cli_switch_to_central,
                 "Switch to central",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__switch_to_peripheral = \
  SL_CLI_COMMAND(cli_switch_to_peripheral,
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  { "switch_to_central", &cli_cmd__switch_to_central, false },
  { "switch_to_peripheral", &cli_cmd__switch_to_peripheral, false },
