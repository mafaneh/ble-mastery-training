...
{
  0x12, 0xc6, 0x43, 0xd4, 0x33, 0xfd, 0xa8, 0x81, 0x82, 0x4a, 0xf3, 0x4e, 0xbd, 0x19, 0x9b, 0x2d, 
  0x5e, 0xe6, 0xe5, 0x7f, 0x08, 0x39, 0xe3, 0xb1, 0x2d, 0x42, 0xb7, 0x9c, 0x19, 0xb9, 0x79, 0xde, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x5d, 0xaf, 0xca, 0x99, 0xff, 0x24, 0x9c, 0xa8, 0x2f, 0x4b, 0xcd, 0x8a, 0x3b, 0x44, 0x36, 0x06, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1b, .uuid = 0x8000, .permissions = 0x902, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_26 },
  ...
  { .handle = 0x1d, .uuid = 0x8001, .permissions = 0x2800, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_28 },
  { .handle = 0x1e, .uuid = 0x000d, .permissions = 0xa03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
